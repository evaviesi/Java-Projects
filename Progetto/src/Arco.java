...
public class Arco implements Comparable {
 ...
 //variabile protected accessibile dalle classi derivate, meno restrittiva della variabile private
  ...
  //verifico se due oggetti della stessa classe sono uguali
  ...
  //se due oggetti sono uguali per equals allora hanno lo stesso valore hash
  public int hashCode() {
